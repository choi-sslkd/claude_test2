...
const RULES_API_URL = 'http://34.64.235.245:3000/admin/rules/active';
const SCORE_API_URL = 'http://34.64.235.245:3000/api/v1/score';
const FILE_SCAN_API_URL = 'http://34.64.235.245:3000/api/v1/scan-file';
